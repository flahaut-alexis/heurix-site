...
const HEURIX_SEARCH_INDEX = [
  ...
  { title: "Fonctionnalités", excerpt: "Cascade d'annotations, tolérance aux fautes, références composées, synonymes métier, résultats explicables.", path: "index.html#fonctionnalites" },
