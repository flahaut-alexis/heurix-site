...
| « 846 résultats » sur `vis`, avec les épingles | `mesure.html:209-228` et EN | revérifié le 4 septembre selon la page | **Contredit ce soir** : les 8 recherches `vis` sur le point public rendent **845**, de 22:23 à 22:28. Non instruit. |
