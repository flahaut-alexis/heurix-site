// Donnees FIGEES au 5 aout 2026, extraites de search-avant-s4/search.js
// le 24 aout 2026.
//
// POURQUOI CE FICHIER. La fixture d'origine contenait le moteur ET les
// donnees. Le test comparait donc deux systemes complets : tout article
// ajoute a search.js creait un ecart qui n'avait rien a voir avec la
// logique, et faisait echouer un test de non-regression du MOTEUR.
//
// Consequence observee : six articles publies etaient absents de
// search.js -- introuvables par la recherche du site -- parce que
// l'etape qui les y ajoute cassait ce test sans moyen documente de le
// reparer.
//
// Ces donnees ne doivent JAMAIS etre mises a jour. Elles sont le point
// de comparaison fixe ; les faire evoluer avec le site retirerait au
// test tout pouvoir de detection.
