...
(function () {
  ...
  var DICT = {
    ...
    "Les résultats s'affichent comme les verrait un visiteur. Essayez une recherche qui vous pose problème aujourd'hui.": "Results appear exactly as a visitor would see them. Try a search that gives you trouble today.",
    "Voici ce que voit votre client": "This is what your customer sees",
    "Chaque fiche indique son rang. Rien n'est simulé : c'est le classement réel de votre catalogue, à cet instant.": "Each card shows its rank. Nothing is simulated: this is your catalog's real ranking, right now.",
    "Comprenez pourquoi ce classement": "Understand why this ranking",
    "Épinglez un produit": "Pin a product",
    "Rien n'est encore enregistré": "Nothing is saved yet",
    "Publier met vos règles en ligne": "Publish puts your rules live",
    "Apprenez ses mots au moteur": "Teach the engine your customers' words",
    "Classez aussi vos pages de catégorie": "Rank your category pages too",
    "Ce lien ouvre le détail : les mots reconnus, les fautes rattrapées, ce qui a pesé dans le score. <strong>Aucun moteur de recherche ne vous montre habituellement cela.</strong>": "This link opens the detail: words recognised, typos caught, what weighed in the score. <strong>No search engine usually shows you this.</strong>",
    "L'épingle met un produit en tête pour cette requête. Les flèches le déplacent d'une place — utile pour un produit en promotion ou une fin de série.": "The pin puts a product at the top for this query. The arrows move it one place — useful for a promotion or an end-of-line item.",
    "Ce bandeau signale un brouillon : <strong>vos visiteurs voient toujours le classement actuel.</strong> Vous pouvez tout annuler sans conséquence.": "This banner marks a draft: <strong>your visitors still see the current ranking.</strong> You can cancel everything without consequence.",
    "À ce moment seulement, vos visiteurs voient le nouveau classement. Déplacer un produit fige aussi les positions au-dessus : plusieurs règles apparaissent donc d'un seul clic.": "Only then do your visitors see the new ranking. Moving a product also locks the positions above it, so several rules appear from a single click.",
    "Vos clients ne tapent pas le vocabulaire de votre catalogue. Un synonyme relie leur mot au vôtre — et les recherches sans résultat vous disent lesquels manquent.": "Your customers don't type your catalog's vocabulary. A synonym links their word to yours — and zero-result searches tell you which ones are missing.",
    "Même principe, sans recherche : vous ordonnez les produits d'une catégorie de votre site. Épinglage par produit, ou mise en avant de toute une famille.": "Same principle, without search: you order the products in a category of your site. Pin by product, or promote a whole family.",
    "Ce produit n'est plus dans le catalogue : la règle ne s'applique pas.": "This product is no longer in the catalog: the rule does not apply.",
    "aucune règle": "no rules",
    "{0} règle(s)": "{0} rule(s)",
    "Chercher « {0} » trouvera aussi « {1} ».": "Searching for \u201c{0}\u201d will also find \u201c{1}\u201d.",
    "« {0} » et « {1} » se trouveront mutuellement.": "\u201c{0}\u201d and \u201c{1}\u201d will find each other.",
    "Fonctionne aussi dans l'autre sens": "Works the other way round too",
    "ex. placo, ba13": "e.g. drywall, plasterboard",
    "trouve": "finds",
    "équivaut à": "means the same as",
    "Aucun synonyme pour l'instant": "No synonyms yet",
    "Recherches sans résultat à corriger": "Searches with no results to fix",
    "Un synonyme relie des mots que vos visiteurs emploient pour désigner le même produit. Les recherches sans résultat sont vos meilleurs candidats : ce sont les mots que le moteur ne reconnaît pas encore.": "A synonym links words your visitors use for the same product. Searches with no results are your best candidates: they are the words the engine does not recognise yet.",
    ...
    "« {0} = {1} »": "\u201c{0} = {1}\u201d",
    "« {0} » est relégué par {1}. La favorisation n'aura aucun effet.": "\u201c{0}\u201d is demoted by {1}. The boost will have no effect.",
    "Mot trouvé": "Word matched",
    "Popularité": "Popularity",
    "Règle": "Rule",
    "Résultat": "Result",
    "Trouvé sur {0}": "Found on {0}",
    "aucune": "none",
    ...
    // Mise en forme des erreurs de validation de l'API (25 aout 2026).
    // Les libelles de champ portent leur article en francais ; en anglais
    // « the » suffit et la phrase se compose de la meme facon.
    "l'email": "the email",
    "le mot de passe": "the password",
    "la raison sociale": "the company name",
    "le numéro de TVA": "the VAT number",
    "le lien": "the link",
    "les produits": "the products",
    "la recherche": "the search query",
    "les synonymes": "the synonyms",
    "le nom": "the name",
    "l'identifiant": "the id",
    "le pack de règles": "the rule pack",
    "le motif": "the pattern",
    "la valeur envoyée": "the submitted value",
    "{0} du produit n°{1}": "{0} of product #{1}",
    "{0} est obligatoire.": "{0} is required.",
    "{0} et {1} sont obligatoires.": "{0} and {1} are required.",
    "{0} ne peut pas être vide.": "{0} cannot be empty.",
    "{0} fait moins de {1} caractères.": "{0} is shorter than {1} characters.",
    "{0} dépasse {1} caractères.": "{0} exceeds {1} characters.",
    "valeur invalide": "invalid value",
    "Et {0} autre(s) problème(s).": "And {0} more problem(s).",
    "Bonjour, {0}": "Hi, {0}",
    "à": "at",
    "tous": "all",
    "Révoquer": "Revoke",
